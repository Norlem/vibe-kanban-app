...
<Card title="VSCode Marketplace" icon="download" href="https://marketplace.visualstudio.com/items?itemName=norlem.vibe-kanban">
...
3. Search for `@id:norlem.vibe-kanban`
4. Click **Install**
</Tab>
...
<Card title="Open VSX Registry" icon="download" href="https://open-vsx.org/extension/norlem/vibe-kanban">
...
**Solutions**:
- Verify the extension is installed by searching `@id:norlem.vibe-kanban` in Extensions
...
<Info>
The extension is designed to work with any VSCode-compatible editor. If you're using a different VSCode fork, try installing from Open VSX Registry using the extension ID `norlem.vibe-kanban`.
</Info>
